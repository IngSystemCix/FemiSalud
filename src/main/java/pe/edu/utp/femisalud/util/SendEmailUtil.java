...
public class SendEmailUtil {
    private static final Dotenv ENV = Dotenv
            .configure()
            .load();
    private static final String EMAIL = ENV.get("GMAIL_EMAIL");
    private static final String APP_CODE = ENV.get("GMAIL_APP_PASS");
    ...
    /**
     * Creates the HTML message to be sent in the email.
     *
     * @param name the recipient's name
