...
public class PatientUserDTO {
    ...
    public PatientUserDTO(String dni, String name, String paternalSurname, String maternalSurname, String email, String phoneNumber, LocalDate birthDate) {
        this.dni = dni;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        PatientUserDTO that = (PatientUserDTO) o;
