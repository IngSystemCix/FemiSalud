...
<nav class="w-[100px] h-full bg-femisalud-900 rounded-full hidden sm:flex flex-col justify-start items-center py-10 gap-6 select-none transition-transform duration-500 ease-in-out" id="sidebar">
    ...
    <ul class="w-full text-white font-bold flex flex-col justify-center items-start gap-3">
        ...
        <li class="container-button w-full flex justify-center items-center">
            <a href="${pageContext.request.contextPath}/call/profile" class="flex justify-center items-center gap-6 group">
                <div class="aspect-square p-5 rounded-full bg-femisalud-300 group-hover:bg-femisalud-900 flex items-center justify-center border-2 border-femisalud-600 group-hover:border-femisalud-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-gear-fill fill-[#115691] group-hover:fill-[#ddedfc] transition-colors duration-300" viewBox="0 0 16 16">
