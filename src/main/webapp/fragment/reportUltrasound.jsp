...
<div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    ...
    <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
        <div class="grid grid-cols-3 gap-3 mb-2">
            <dl class="bg-orange-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                ...
                <dd class="text-orange-600 dark:text-orange-300 text-sm font-medium">Visualizadas</dd>
            </dl>
            <dl class="bg-teal-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center">
                ...
                <dd class="text-teal-600 dark:text-teal-300 text-sm font-medium">No visualizadas</dd>
            </dl>
            <dl class="bg-blue-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                ...
                <dd class="text-blue-600 dark:text-blue-300 text-sm font-medium">Descargadas</dd>
            </dl>
        </div>
    ...
    <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
        <div class="flex justify-between items-center pt-5">
            ...
            <button class="w-auto bg-femisalud-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                Descargar ecografías
            </button>
        </div>
    </div>
</div>