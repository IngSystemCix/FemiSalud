    ...
    <ul class="w-full text-white font-bold flex justify-center items-center gap-3">
        ...
        <li class="container-button w-full flex justify-center items-center">
            <a href="${pageContext.request.contextPath}/admin/clinical-notes" class="flex justify-center items-center gap-6 group">
                <div class="aspect-square p-3 rounded-full bg-femisalud-300 group-hover:bg-femisalud-900 flex items-center justify-center border-2 border-femisalud-600 group-hover:border-femisalud-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" class="bi bi-journal-bookmark-fill fill-[#115691] group-hover:fill-[#ddedfc] transition-colors duration-300" viewBox="0 0 16 16">
        ...
        <li class="container-button w-full flex justify-center items-center">
            <a href="${pageContext.request.contextPath}/admin/register-call-center" class="flex justify-center items-center gap-6 group">
                <div class="aspect-square p-3 rounded-full bg-femisalud-300 group-hover:bg-femisalud-900 flex items-center justify-center border-2 border-femisalud-600 group-hover:border-femisalud-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-headset fill-[#115691] group-hover:fill-[#ddedfc] transition-colors duration-300" viewBox="0 0 16 16">
