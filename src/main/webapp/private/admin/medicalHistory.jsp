...
<jsp:include page="/fragment/Head.jsp">
    <jsp:param name="title" value="Historial médico" />
</jsp:include>
...
<jsp:include page="/fragment/alert/AlertError.jsp" >
    <jsp:param name="id" value="alert-error-invalid-dni"/>
    <jsp:param name="message" value="Por favor, selecciona un DNI válido."/>
</jsp:include>
    ...
    <section class="w-full h-[calc(100vh-10rem)] sm:h-[calc(100vh-5rem)] flex flex-col justify-start items-center p-4 md:p-6 bg-gradient-to-r from-white via-white to-transparent overflow-auto gap-6">
        <div class="w-full h-auto flex flex-col tablet-vertical:flex-row justify-center items-center gap-6">
            <div class="w-full h-auto flex justify-center items-center">
                <form action="${pageContext.request.contextPath}/add-medical-history" method="post" class="w-full h-auto bg-femisalud-300 rounded-lg p-6 flex flex-col gap-6">
                    <h2 class="w-full text-center text-inter text-femisalud-900 text-2xl font-bold">Registro del Historial de la paciente</h2>
                    <p class="text-inter">Por favor, completa el formulario del registro del historial clínico.</p>
                    <div class="w-full flex flex-col gap-3">
                        <label for="dni" class="font-bold text-femisalud-900">DNI de la paciente:</label>
                        <div class="w-full flex justify-center items-center gap-3">
                            <select name="dni" id="dni" class="rounded-lg w-full">
                            ...
                            <button type="button" id="button-search-dni" class="px-3 py-1 bg-green-600 text-white font-bold rounded-lg">Buscar</button>
                        </div>
                    </div>
                    <div class="w-full flex flex-col gap-3">
                    ...
                    <div class="w-full flex flex-col gap-3">
                        ...
                        <input type="date" name="date_end_pregnancy" id="date_end_pregnancy" class="rounded-lg w-full" readonly>
                    </div>
                    <div class="w-full flex flex-col gap-3">
                    ...
                    <div class="w-full flex flex-col gap-3">
                        ...
                        <select name="type_pregnancy" id="type_pregnancy" class="rounded-lg w-full" required>
                    ...
                    <button type="submit" class="w-full bg-green-600 text-white font-bold text-lg rounded-lg py-2">Agregar registro</button>
                </form>
            </div>
            <div class="w-full h-full flex flex-col gap-6">
                <h2 class="w-full text-center text-inter text-femisalud-900 text-2xl font-bold">Historial de la paciente</h2>
                <div class="w-full h-[24rem] max-h-[24rem] overflow-y-auto rounded-lg">
                    <table class="min-w-full bg-white shadow-md rounded-lg">
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-4 sticky top-0 bg-femisalud-900">Cantidad de hijos</th>
                            <th class="px-6 py-4 sticky top-0 bg-femisalud-900">Fecha de atención</th>
                        </tr>
                        </thead>
...
<script src="${pageContext.request.contextPath}/assets/js/inputDateValidateFormAddMedicalHistory.js"></script>
<script src="${pageContext.request.contextPath}/assets/js/searchMedicalHistory.js"></script>
</body>
</html>
