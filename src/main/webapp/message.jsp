...
<div class="flex w-full h-full">
    ...
    <main class="bg-gray-100 h-full w-full flex flex-col ">
            ...
            <div class="flex justify-start">
                <div class="bg-blue-100 p-4 rounded-lg max-w-lg flex items-start space-x-3">
                    ...
                    <div class="max-w-full">
                        <p class="text-gray-800 font-bold break-words">Buen día.</p>
                        <p class="text-gray-800 font-bold break-words">
                            Por favor, escoge una opción:</p><br>
                        <div class="flex flex-col gap-3">
                            <p class="text-gray-800 font-bold break-words cursor-pointer bg-blue-700 text-white rounded-lg p-1 ">¿Cuáles son los horarios de atención?</p>
                            <p class="text-gray-800 font-bold break-words cursor-pointer bg-blue-700 text-white rounded-lg p-1">¿En dónde se encuentran ubicados?</p>
                            <p class="text-gray-800 font-bold break-words cursor-pointer bg-blue-700 text-white rounded-lg p-1">¿Atienden solo citas programadas?</p>
                            <p class="text-gray-800 font-bold break-words cursor-pointer bg-blue-700 text-white rounded-lg p-1">¿Cuál es el precio por consulta?</p>
                            <p class="text-gray-800 font-bold break-words cursor-pointer bg-blue-700 text-white rounded-lg p-1">¿En qué semana se realiza la ecografía morfológica?</p>
                            <p class="text-gray-800 font-bold break-words cursor-pointer bg-blue-700 text-white rounded-lg p-1">¿En qué semana se realiza la ecografía genética?</p>
                            <p class="text-gray-800 font-bold break-words cursor-pointer bg-blue-700 text-white rounded-lg p-1">¿En qué semana se realiza la ecografía Doppler?</p>
                            <p class="text-gray-800 font-bold break-words cursor-pointer bg-blue-700 text-white rounded-lg p-1">¿Cuánto debo pagar para que realicen una ecografía si mi embarazo es múltiple? (Más de un feto)</p>
                            <p class="text-gray-800 font-bold break-words cursor-pointer bg-blue-700 text-white rounded-lg p-1">Deseo comunicarme con un asesor</p>
                        </div>
                        <p class="text-xs text-gray-500">23/09/2024 21:00</p>
                        <span class="ml-auto bg-green-500 text-white text-xs px-2 py-1 font-bold rounded-full">Leído</span>
                    </div>
